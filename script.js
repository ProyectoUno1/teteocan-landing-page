...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Close mobile menu when clicking outside (keeping for additional safety)
...
function handleSwipe() {
    const mobileNav = document.getElementById('mobileNav');
    const menuIcon = document.getElementById('menuIcon');    if (touchEndX < touchStartX - 50 && mobileNav.classList.contains('active')) {
